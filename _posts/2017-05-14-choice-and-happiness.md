...
The first video is that of _Malcolm gladwell_ ([here](https://www.ted.com/talks/malcolm_gladwell_on_spaghetti_sauce)) where he talks about the food industry (we want to see the obsevations beyond this domain as well) and it's earlier assumptions. He tells a story of how Howard markowitz changed the food industry in three important ways:
...
Now we have two types of irrational decision making. First as I explained we just pick what was chosen for us. The second type can be explained from dating example. Out of two people on a dating site (both of them can be comparable based on looks) the one is popular whose similar uglier version is introduced. This is constantly used by marketers when providing offers, in malls, in mutual funds by providing an extra option to compare with. This tells we are not so much in control of our decisions. Dan ariely says our mental world has limitations just like physical world. Understanding our congnitive limitations will help us design better sotck market, healthcare, retirement plans and other important stuff.

But how do we solve the conflict. Dan Ariely says introduction of an inferior option (useless option which no body wants) helps people figure out what they wanted.


Here is my opnion:

Barry concluding remarks are 'some choice are better than none but more choice is not better than some choice'. Here 'some choice' has to defined by our welfare, past our welfare is more choice.

It's not proper quantization, see that welfare is not limited. We always want more. Now the sense I believe that he talks about is the same, whatever fills the needs, the requirement but it doesn't adress the asthetic part of the products or products which have more of asthetic part.
...
So we see there are two types of properties in a product, it's functional value - based on the present/future need. The other one is the creative value which is brand(this may be a need for some people but I will still qualify it as a taste), looks, appearance, garnish, ambience, art. One may find drastic differences in the value of the two properties. 
What and why the value of a $20,000 art hanging on a wall has much less use than a much cheaper window in it's place for an example or a simple laptop or tablet, ofcourse if you have that painting, you must be having a good laptop already or another window in it's place. Which means you have ample money. Is it that people who have more money become inclined to taste side of the product and willing to compromise in functionality. You know higher functionality and asthetics is a higher risk of robbery, why risk you happiness. I feel it has to do with taste and taste affordability and buying wisdom.

Some will argue about the design of the product. I would say doesn't it merge the two of it. Some will say this painting is of historical value. I understand and for this reason it needs to be saved and preserved not owned for show off. Some will say it's about the feelings it generates in a persono when you look at the art. I am not talking about art. But if it's such an art that can move a million people away to do from what they do in daily life then I would say that should be included in education and it simply doesn't qualify for a mere money value. 

Governments and corporates build things that we like, pay attention to, your one cent is their one billion. This accumulation of attention is so powerfull and few govern it because they seem to have cracked crowd mindset. Apple for example has design and fucntionality but in countries like India what decides it's value - 'Staus symbol'. As a result many people don't invest into houses but buy a 70k rupee phone. In their mind it gives them immediate status. That amount could be saving in the form of gold. I have observed this with regural income people. And they have a hard time explaining why they bought it and why it was needed for them. But this is beyond our point and our conflict. I just stepped over the boundry and I pull back.

1. More choices give us more freedom to choose for our welfare. We choose from better options, better is defined by more quality/features in lesser price. Quality can be anything, a time saving option can also be a quality. According to Barry we don't want too many choices, that makes us miserable after buying. According to him the key to happiness is less expectations. The user can implement it on their side, it's like a personal tap. But how to know how many choices is too many choices? We just saw Dan says introduction of one useless choice help people to know what they want. I think of following things.

a. Decide on the number of choices based on market study. Do a market segmentation properly, so as to know how much diversification is required. United Colors of Benetton doesn't produce too many shoes or designs. Their showrooms keep some of it.

b. Now all these choices will be available to user at the same time. How will he get to know what was manufactured for him. So Market the right thing to the right person is the key(key to happiness). The user won't get blinded by so many options and eventually not choose anything. Levis skinny fit was something all skinny people were looking for. And making proper segmented sizes helps people to go to the proper size in mind. 

c. In cell phones or bikes people don't seem so confused as buying apparells. It's easier to reject based on the features. Such products suit the types of needs of people. Here too much number of the same kind is not ok. incremental models are what to be found, more price based on more number of the features. Mutual funds need to be designed better.

d. If there are too much asethic part of a product it can be mind boggling. Inform the user by telling how the design is suited for the specific user rather than come and try all our products and choose the best one from it. User ain't goona choose from that. 

e. For the user don't be guided by guilt but by need. Use the tap.
f. Give people what they want when and where they know about it. Choice are reqired to clear this when they don't have an idea.
